'''
Maps all names of layers in the neural networks to that of actual stable diffusion. This way, we are able to use strict=True argument when loading model state dict. 
'''
